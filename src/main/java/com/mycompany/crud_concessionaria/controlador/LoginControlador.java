...
import com.mycompany.crud_concessionaria.modelo.dao.UsuarioDAO;
import com.mycompany.crud_concessionaria.modelo.entidade.Usuario;
...
public class LoginControlador extends HttpServlet {
    ...
    protected void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (usuario != null && BCrypt.checkpw(password, usuario.getPasswordHash())) {
            ...
            response.sendRedirect("/crud_concessionaria/index.jsp");
        } else {
