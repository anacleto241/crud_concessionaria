 ...
 */
package com.mycompany.crud_concessionaria.servico;
...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (path.startsWith("/public/") || path.equalsIgnoreCase("/login.jsp")
                || path.equalsIgnoreCase("/com/mycompany/crud_concessionaria/controlador/LoginControlador")
                || path.equalsIgnoreCase("/com/mycompany/crud_concessionaria/controlador/LogountControlador")
            ...
            if (httpRequest.getSession().getAttribute("user") == null) {
                httpResponse.sendRedirect("/crud_concessionaria/login.jsp"); // Redirecionar para a página de login
